...
def handshake():
    ...
    with open('cloud.key.hacklab', 'wb') as f:
        print ('file opened')
        while True:
    ...
    print('Successfully get the file of size', os.path.getsize('cloud.key.hacklab'))
    
    print("decrypting the file \n")
    cloud_key_file = decrypt(PMK_key, 'cloud.key.hacklab')

    print("acquired cloud key file size\n", os.path.getsize(cloud_key_file))
