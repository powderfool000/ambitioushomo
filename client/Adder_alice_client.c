...
int main() {
    ...
    */
    ...
    for (int i=0; i<32; i++) {
        bootsSymEncrypt(&ciphertext1[i], (plaintext1>>i)&1, bk);
    }
    ...
    for (int i=0; i<32; i++) {
        bootsSymEncrypt(&ciphertext2[i], (plaintext2>>i)&1, bk);
    }
    ...
    for (int i = 0; i<32; i++) {
	bootsSymEncrypt(&ciphertext3[i], (plaintext3 >> i) & 1, bk);
    }
